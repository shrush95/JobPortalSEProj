...
<head>
    ...
    <title>Job Portal - Employee Signup</title>
...
<body class="index">
    <div class="container" style="z-index:100;margin-top:50px;width:40%">
	 <div class="panel panel-default">
                            ...
                            <form role="form" method="post" action="esignup.php">
            <div class="form-group">
              <label for="usrname">FIRST NAME</label>
              <input type="text" class="form-control" id="fstname" name="fname" placeholder="Enter first name">
            </div>
            <div class="form-group">
              <label for="usrname">LAST NAME</label>
              <input type="text" class="form-control" id="lstname" name="lname" placeholder="Enter last name">
            </div>
			<div class="form-group">
			...
			<div class="form-group">
              <label for="hscmarks">HSC MARKS</label>
              <input type="number" class="form-control" id="hscmarks" name="hsc" placeholder="Enter hsc marks">
            </div>
			<div class="form-group">
              <label for="BEmarks">BE MARKS</label>
              <input type="number" class="form-control" id="BEmarks" name="be" placeholder="Enter BE marks">
            </div>
