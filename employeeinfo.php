            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="section-title text-center">
                            <?php print"<h2><strong>$fname $lname's PROFILE</strong></h2>"; ?>
							<p> </p>
                        </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="team-member">
                        ...
                        <div class="team-details">
                            <?php print"<h4>$fname $lname</h4>"; ?>
                            <div class="designation">Information Technology</div>
				...
				<div class="contact-info waves-effect" style="width:100%">
					...
					<ul>
						...
						<li><strong>HSC Marks: </strong>$hsc</li>
						<li><strong>BE Marks: </strong>$be</li>"; ?>
					</ul>
				</div>
				</div>
	</div>
